...
#define MAX_PWM_RESOLUTION 16
  ...
  static TimerCompareFormat_t _writeResolution = RESOLUTION_8B_COMPARE_FORMAT;
  static TimerCompareFormat_t _internalWriteResolution =
#if RESOLUTION_8B_COMPARE_FORMAT > RESOLUTION_16B_COMPARE_FORMAT
      MAX_PWM_RESOLUTION
#else
  ...
  void analogWriteResolution(int res)
  {
    if ((res > 0) && (res <= 32))
    {
      _writeResolution = static_cast<TimerCompareFormat_t>(res);
      if (_writeResolution > RESOLUTION_16B_COMPARE_FORMAT)
      {
        _internalWriteResolution = RESOLUTION_16B_COMPARE_FORMAT;
      }
      else
      {
